...
for i in video_game_sales:
    ...
    global_sales = global_sales + i[9]
avg_global_sales = global_sales/20 
top_game_share = video_game_sales[0][9]/global_sales*100

print(f"The total number of games is: ", total_games)
print(f"The average global sales across all 20 games is: ", avg_global_sales)
print(f"The percentage of Wii Sports sales in global sales is: {top_game_share:.2f}% ")
